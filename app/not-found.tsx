...
export default function NotFound() {
  return (
    <>
      <head>
	<meta property="og:image" content={`https://${process.env.VERCEL_URL || "localhost:3000"}/404.jpg`}/>
	...
	<meta name="twitter:image" content={`https://${process.env.VERCEL_URL || "localhost:3000"}/404.jpg`}/>
      </head>
